...
class RoadNetworkMapFull:
    ...
    def get_near_seg(self, gps, vec_l, vec_p, search_dist=100, beta=15):
        step = 10
    ...
    def get_src_segs(self, gps_seq, search_dist, beta):
        ...
        for ds_pt, (p1, p2), (p3, p4) in zip(gps_seq, vecs_later, vecs_pre):
            segs = self.get_near_seg(ds_pt, (p2[0] - p1[0], p2[1] - p1[1]), (p4[0] - p3[0], p4[1] - p3[1]), search_dist, beta)
            ls_src_segs.append(segs)
        return ls_src_segs
